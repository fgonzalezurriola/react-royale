                    ...
                    <div className="mt-8 bg-slate-100 border border-slate-200 rounded-xl p-6">
                        ...
                        <ul className="space-y-2 text-slate-700">
                            <li className="flex items-start gap-2">
                                ...
                                <span>Make the challenge hilariously specific (e.g., "Build a login form with at least 20 unnecessary animations")</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-slate-500 mt-1">•</span>
                            ...
                            <li className="flex items-start gap-2">
                                <span className="text-slate-500 mt-1">•</span>
                                <span>Schedule voting period after submissions close to let the community decide the winner</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-slate-500 mt-1">•</span>
